...
// import 'package:clinic_web_dashboard/screens/admin/messages_screen.dart';
// import 'package:clinic_web_dashboard/screens/admin/notifications_screen.dart';
...
//         '/nurse': (context) => const NurseDashboard(),
...
//       ),
//       body: const Center(
//         child: Text('Forgot Password feature under development.'),
//       ),
//     );
//   }
// }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/doctor-appointments': (context) => const DoctorsAppointmentScreen(),
